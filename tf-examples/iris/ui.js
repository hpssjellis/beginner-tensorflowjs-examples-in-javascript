...
var ui = ui || {}      // the ui namespace

var embed = vegaEmbed   // vega uses vegaEmbed not tensorflows embed
...
ui.clearEvaluateTable = function() {
...
ui.plotLosses = function(lossValues, epoch, newTrainLoss, newValidationLoss) {
...
ui.getManualInputData = function() {
  return [
...
ui.setManualInputWinnerMessage = function(message) {
...
ui.renderLogitsForManualInput = function(logits) {
...
ui.renderEvaluateTable = function(xData, yTrue, yPred, logits) {
  const tableBody = document.getElementById('evaluate-tbody');
...
ui.wireUpEvaluateTableCallbacks = function(predictOnManualInputCallback) {
...
ui.loadTrainParametersFromUI = function() {
  return {
